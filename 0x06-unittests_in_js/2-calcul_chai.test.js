...
describe('calculateNumber', function () {
  ...
  // Additional scenarios not covered in the initial code snippet
  describe('DIVIDE with negative numbers', function () {
    it('should return -2', function () {
      chai.expect(calculateNumber('DIVIDE', -9.5, 4.5)).to.equal(-2);
    });
  });

  describe('SUBTRACT with negative numbers', function () {
    it('should return -2', function () {
      chai.expect(calculateNumber('SUBTRACT', -5, 3)).to.equal(-2);
    });
  });

  describe('SUM with negative numbers', function () {
    it('should return -3', function () {
